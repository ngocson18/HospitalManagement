...
{
    public class tbl_TreatmentController : Controller
    {
        ...
        public ActionResult Index(int? page)
        {
            ...
            var tbl_Customer = db.tbl_Customer.Where(t => t.status == 3).Include(t => t.tbl_Office).Include(t => t.tbl_ServiceUnit).OrderBy(x => x.id);
            //return View(tbl_Customer.ToList());
            return View(tbl_Customer.ToPagedList(pageNumber, pageSize));
        }

        // GET: tbl_Treatment/Details/5
